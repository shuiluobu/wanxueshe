...
public class LogAdvice {
	...
	@Pointcut("@annotation(org.wxs.core.anno.Log)")
	...
	public void doBefore(JoinPoint joinPoint) {
		...
		if(log != null){
			...
			if(logApi != null){
				...
				logBean.setRequestParams(BaseUtil.toJson(request.getParameterMap()));
